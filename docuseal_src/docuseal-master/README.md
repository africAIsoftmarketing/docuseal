...
> **Heroku deployment:** This fork is adapted for a Docker-free Heroku deploy
> (web + worker + Postgres + Redis + S3). See **[HEROKU_DEPLOY.md](HEROKU_DEPLOY.md)**
> and **[docs/HEROKU_ENV_VARS.md](docs/HEROKU_ENV_VARS.md)**. Quick start:
> `./bin/heroku_setup.sh my-app`.
